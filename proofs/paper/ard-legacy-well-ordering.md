# ARD-legacy: Well-Ordering in Weak Set Theory · [中文版](ard-legacy-well-ordering.zh-CN.md)

The legacy mathematical proof is preserved. ARD in this paper means ARD-legacy; its lower-row package is not the new rule. See [ARD skyline](ard-well-ordering.md).


2026-09-13. ARD means Anchored Row Diagrams.

[PDF](ard-legacy-well-ordering.pdf) · [definition](../../notations/ARD-legacy/definition.md) · [NER arc-diagram expander](../../notations/ARD-legacy/ARD-arcs.ne-rewritten.js) · [Python](../../notations/ARD-legacy/ard.py) · [ordinary Lean entry point](../../lean/ARD-legacy/src/ARDFinal.lean)
