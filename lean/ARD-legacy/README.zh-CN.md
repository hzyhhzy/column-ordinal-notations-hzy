# ARD-legacy：独立 Lean 子项目 · [English](README.md)

本项目保留旧版 ARD，历史命名空间仍为 `OrdinalFormal.ARD`。默认新版见 [ARD 轮廓项目](../ARD/README.zh-CN.md)。2026-09-16 已在新目录重新核查：50 模块、156 份公理报告，20 个旧版私有模块重新编译，30 个共享模块经完整指纹校验复用。下方 2026-09-14 记录是历史拆分验收，源码和数学规则没有改动。
