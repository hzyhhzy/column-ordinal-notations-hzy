import ARD2SkylineDomain

/-! A semantic descent adapter for the actual skyline ARD2 fundamental sequence.
The final theorem instantiates all inputs with proved concrete results; this
adapter by itself is not an unconditional ARD2 well-ordering claim. -/
