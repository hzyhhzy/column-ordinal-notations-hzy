...
Run python -B tests/test_ard2_legacy.py. --vectors emits Python-checked vectors for
...
START = monotonic()
TICKS = 0
spec = importlib.util.spec_from_file_location("release_ard2", ROOT / "notations/ARD2-legacy/ard2.py")
...
def main():
    ...
    assert str(TOP) == "Limit of ARD2-legacy" and ZERO.kind == "zero"
