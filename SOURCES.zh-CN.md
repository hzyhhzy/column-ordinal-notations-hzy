...
2026-09-17：默认 ARD2 换成轮廓版。原 21 个数学模块移到 `lean/ARD2-legacy/src/`，内容哈希不变；新版另有 7 个模块，显式依赖旧语义。旧、新精确闭包分别为 51、57，联合闭包为 338。旧稿、程序和五种显示均保留，来源边界不变。当前证明范围见[新版说明](lean/ARD2/README.zh-CN.md)；新旧同构仍是纸面结果。
